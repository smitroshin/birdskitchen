...
class RecipeGeneratorModalNotExtended extends React.Component {
  ...
  plusQty = () => {
    ...
    this.setState({
      count: ++count,
      ingredients: this.props.item.ingredients.replace(
        /(\d+[\d./,]*|\d)/g,
        (k) =>
          ((evaluate(k) * count) / this.state.initialCount)
            .toFixed(2)
            .replace(/\.0+$/, '')
      ),
    });
          ...
          <div className="image-tech-wrapper">
            ...
            <div className="tech">
              <div className="source-url">
                ...
                <div
                  className="ext-link"
                  onClick={() => this.openLinkInBrowser(item.sourceurl)}
                >
                  {item.sourceurl}
                </div>
              </div>
          ...
          <div className="ingredients-wrapper">
            <label>
              <div className="plus-minus">
                <div className="plus" onClick={this.plusQty}>
                  <SvgIcon name="plus" />
                </div>
                <div className="minus" onClick={this.minusQty}>
                  <SvgIcon name="minus" />
                </div>
              </div>
              <span>
              ...
              <span className="qty">
                ...
                <span id="qtynb">{this.state.count}</span>
              </span>
            </label>
...
const RecipeGeneratorModal = hoistStatics(
  withTranslation()(RecipeGeneratorModalNotExtended),
  RecipeGeneratorModalNotExtended
);
