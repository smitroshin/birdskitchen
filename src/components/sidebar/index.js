    ...
    return (
      <div className="comp_sidebar">
        ...
        <div className="header">
          <div
            onClick={() => this.setState({ recipeModalVisible: true })}
              ...
              <ul className="menu-list">
                <li
                  className={`menu-list-item ${
                    selectedMenu.slug === SearchResult.slug ? 'active' : ''
                  }`}
                >
                  ...
                  <div className="others-container">
                    <div className="text-container">{t(SearchResult.name)}</div>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <ul className="menu-list">
              {MainMenus.map((value, index) => {
                ...
                return (
                  <li
                    key={index}
                    onClick={() => this.setSelectedMenu(value, 'menu')}
              ...
              <ul className="menu-list">
                {tags.map((value, index) => {
                  ...
                  return (
                    <li
                      key={index}
                      onClick={() => this.setSelectedMenu(value, 'tag')}
                      className={containerClassName}
                    >
                      <div className="icon-container">
                        <SvgIcon name={'tag'} />
              ...
              <ul className="menu-list">
                {categories.map((value, index) => {
                  ...
                  return (
                    <li
                      key={index}
                      onClick={() => this.setSelectedMenu(value, 'category')}
                      className={containerClassName}
                    >
                      <div className="icon-container">
                        <SvgIcon name={'meal'} />
