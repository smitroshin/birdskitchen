...
class UnitConverterNotExtended extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      ...
      prevState.fromTemperatureMeasure !== this.state.fromTemperatureMeasure ||
        ...
        <div className="unit-converter-inner">
          ...
          <div className="body">
            <div className="buttons">
              <span className="mass" onClick={this.toggleMassVisibility}>
                <SvgIcon name="mass" />
                <span className="label visible">{t('weight')}</span>
              </span>
              <span
              ...
              <span className="volume" onClick={this.toggleVolumeVisibility}>
                <SvgIcon name="volume" />
            ...
            <div className="calcs">
              <div className="calc-mass visible">
                <div className="left">
                  ...
                  />
                  <span>
                    <select onChange={this.fromMassMeasureHandleChange}>
                      {mass.map((option) => (
                ...
                <div className="right">
                  ...
                  />
                  <span>
                    <select onChange={this.toMassMeasureHandleChange}>
                      {mass.map((option) => (
                        <option key={option.index} value={option.name}>
                          {t(option.label)} - {option.unit}
                        </option>
              ...
              <div className="calc-temperature">
                <div className="left">
                  ...
                  />
                  <span>
                    <select onChange={this.fromTemperatureMeasureHandleChange}>
                ...
                <div className="right">
                  ...
                  />
                  <span>
                    <select onChange={this.toTemperatureMeasureHandleChange}>
                      {temperature.map((option) => (
                        <option key={option.index} value={option.name}>
                          {t(option.label)} - {option.unit}
                        </option>
              ...
              <div className="calc-volume">
                <div className="left">
                  ...
                  />
                  <span>
                    <select onChange={this.fromVolumeMeasureHandleChange}>
                      {volume.map((option) => (
                        <option key={option.index} value={option.name}>
                          {t(option.label)} - {option.unit}
                        </option>
                ...
                <div className="right">
                  ...
                  />
                  <span>
                    <select onChange={this.toVolumeMeasureHandleChange}>
                      {volume.map((option) => (
                        <option key={option.index} value={option.name}>
                          {t(option.label)} - {option.unit}
                        </option>
