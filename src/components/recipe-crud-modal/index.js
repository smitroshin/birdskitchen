...
class RecipeCrudModalNotExtended extends React.Component {
  ...
  onSubmit = () => {
    ...
    if (undefined === formValues.ingredients || '' === formValues.ingredients) {
      ...
      formValues.ingredients = formValues.ingredients.replace(/⅛/g, '1/8');
      formValues.ingredients = formValues.ingredients.replace(/⅜/g, '3/8');
      formValues.ingredients = formValues.ingredients.replace(/⅝/g, '5/8');
      formValues.ingredients = formValues.ingredients.replace(/⅞/g, '7/8');
      formValues.ingredients = formValues.ingredients.replace(
        /(?: )?(1+)\/(2+)/g,
        '.5'
      );
      ...
      formValues.ingredients = formValues.ingredients.replace(/^.(\d)/g, '0$&');
      formValues.ingredients = formValues.ingredients.replace(
        /( |[ X][.]+)/g,
        ''
      );
      formValues.ingredients = formValues.ingredients.replace(/\d+/g, (k) =>
        Number(k).toFixed(0)
      );
    }
  ...
  _footer = () => {
    return (
      <div className="footer-buttons">
        <span className={this.state.newRecipe} onClick={this.handleWebImport}>
  ...
  render() {
    ...
    const modalTitle =
      `${undefined !== id ? t('Edit') : t('New')}` + ' ' + `${t('Recipe')}`;
        ...
        >
          <div className="webimport-modal">
            <div className="webimport-inner">
              ...
              <div className="body">
                <div className="label">{t('Please enter a recipe url')}</div>
                <div className="note">
                ...
                <div className="input">
                  <input type="text" id="websiteurl" name="websiteurl"></input>
                ...
                <div className={this.state.buttonsClass}>
                  <div className="message">
                    {t('Do you want to import this recipe?')}
                  </div>
                  <button className="import-yes" onClick={this.importYes}>
                    {t('Yes')}
                  </button>
                  <button className="import-no" onClick={this.importNo}>
                    {t('No')}
                  </button>
                </div>
              </div>
            ...
            <div className="title-tech-wrapper">
              ...
              <div className="tech">
                <ChoiceField
                  ...
                  value={
                    'undefined' !== typeof formValues.difficultylevel
                ...
                <NumberField
                  ...
                  label={
                    <span>
                      <SvgIcon name="servings" /> {t('Servings')}
                    </span>
                  }
                  min={1}
                  step={1}
                ...
                <TextField
                  ...
                  label={
                    <span>
                      <SvgIcon name="clock" /> {t('Prep time')}
                    </span>
                  }
                ...
                <TextField
                  ...
                  label={
                    <span>
                      <SvgIcon name="clock" /> {t('Cook time')}
                    </span>
                  }
              ...
              <div className="tech-two">
                <ChoiceField
                  ...
                  label={
                    <span>
                      <SvgIcon name="meal" /> {t('Category')}
                    </span>
                  }
                  id={formValues.categories}
                  value={
                    'undefined' !== typeof formValues.categories
                ...
                <div className="comp_fe_choice-field">
                  <div className="form-group rating">
                    <label className="form-label">
                      <span>
                        <SvgIcon name="toque" /> {t('Rating')}
                      </span>
                    </label>
                    <StarRatingComponent
                      name="rating"
                      value={
                        'undefined' !== typeof formValues.rating
                          ? formValues.rating
                          : 0
                      }
            ...
            <div className="comp_fe_image-field">
              ...
              {this.state.isMouseInside ? (
                <div className="uploader-wrapper">
                  <div className="uploader-close" onClick={this.showImgPreview}>
                    x
                  </div>
                  <ImageUploader
                    ...
                    fileTypeError={' ' + t('is not a supported image file')}
                  />
                </div>
              ) : null}
            </div>
          ...
          <div className="textareas-wrapper">
            <TextareaField
              ...
              label={
                <span>
                  <SvgIcon name="ingredients" /> {t('Ingredients')}
                </span>
              }
