...
class SettingsModalNotExtended extends React.Component {
  ...
  render() {
    const { dbDirectory, backupDirectory, backupFiles, appTheme, appLang } =
      this.state;
      ...
      <div className="comp_settings-modal">
        ...
        >
          <div className="tabs-header-container">
            <ul>
              <li
                className={'about' === selectedTab ? 'active' : ''}
                onClick={() => this.onClickTabHeader('about')}
              >
                <span>{t('About')}</span>
              </li>
              <li
                className={'storage' === selectedTab ? 'active' : ''}
                onClick={() => this.onClickTabHeader('storage')}
              >
                <span>{t('Storage')}</span>
              </li>
              <li
                className={'themes' === selectedTab ? 'active' : ''}
                onClick={() => this.onClickTabHeader('themes')}
              >
                <span>{t('Theme')}</span>
              </li>
              <li
                className={'language' === selectedTab ? 'active' : ''}
                onClick={() => this.onClickTabHeader('language')}
              >
                <span>{t('Language')}</span>
              </li>
              <li
                className={'help' === selectedTab ? 'active' : ''}
          ...
          <div className="tabs-content-container">
            <div
              className={`content${'storage' === selectedTab ? ' active' : ''}`}
            >
            ...
            <div
              className={`content${'themes' === selectedTab ? ' active' : ''}`}
            >
              <div className="theme-section">
                <ul>
                  <li
                    onClick={() => this.changeTheme('athens')}
                    className={'athens' === appTheme ? 'active' : ''}
                  >
                    <div className="image-container">
                      <img
                        src={'./images/themes/athens.png'}
                        alt="Athens"
                        width={240}
                      />
                    </div>
                  ...
                  <li
                    ...
                    className={'teal' === appTheme ? 'active' : ''}
                  >
                    <div className="image-container">
                      <img
                  ...
                  <li
                    onClick={() => this.changeTheme('woodsmoke')}
                    className={'woodsmoke' === appTheme ? 'active' : ''}
                  >
                    <div className="image-container">
                      <img
                        src={'./images/themes/woodsmoke.png'}
                        alt="Woodsmoke"
                        width={240}
                      />
                    </div>
            ...
            <div
              className={`content${'help' === selectedTab ? ' active' : ''}`}
            >
              <div className="help-section">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          ...
                          {t('or')} &#8984; ;{' '}
                          <span className="tiny-text">{t('(Mac)')}</span>
                        </td>
                        <td>{t('Preferences')}</td>
                      </tr>
                      <tr>
                ...
                <div className="sub-title">
                  <span>{t('Recipe Import - Supported Websites')}</span>
                </div>
                <div className="info">
                  <div className="accordion">
                    ...
                    <div className="websites accordion-content">
                      <div
                        ...
                        onClick={() =>
                          shell.openExternal('https://www.101cookbooks.com')
                        }
                      >
                        101 Cookbooks
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.allrecipes.com')
                        }
                      >
                        Allrecipes
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.ambitiouskitchen.com')
                        }
                      >
                        Ambitious Kitchen
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.bbcgoodfood.com')
                        }
                      >
                        BBC Good Food
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.bonappetit.com')
                        }
                      >
                        Bon Appétit
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.budgetbytes.com')
                        }
                      >
                        Budget Bytes
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.closetcooking.com')
                        }
                      >
                        Closet Cooking
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://cookieandkate.com')
                        }
                      >
                        Cookie and Kate
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://damndelicious.net')
                        }
                      >
                        Damn Delicious
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('http://www.eatingwell.com')
                        }
                      >
                        EatingWell
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.epicurious.com')
                        }
                      >
                        Epicurious
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.food.com')
                        }
                      >
                        Food
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.foodandwine.com')
                        }
                      >
                        Food & Wine
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.gimmesomeoven.com')
                        }
                      >
                        Gimme Some Oven
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://minimalistbaker.com')
                        }
                      >
                        Minimalist Baker
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.myrecipes.com/recipe')
                        }
                      >
                        MyRecipes
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://nomnompaleo.com')
                        }
                      >
                        Nom Nom Paleo
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://omnivorescookbook.com')
                        }
                      >
                        Omnivore's Cookbook
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://pinchofyum.com')
                        }
                      >
                        Pinch of Yum
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.thepioneerwoman.com')
                        }
                      >
                        Pioneer Woman (The)
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://therealfoodrds.com')
                        }
                      >
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.recipetineats.com')
                        }
                      >
                        RecipeTin Eats
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.seriouseats.com')
                        }
                      >
                        Serious Eats
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://smittenkitchen.com')
                        }
                      >
                        Smitten Kitchen
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.thespruceeats.com')
                        }
                      >
                        Spruce Eats (The)
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.woolworths.com.au')
                        }
                      >
                        Woolworths
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.yummly.com')
                        }
                      >
                        Yummly
                      </div>
                  ...
                  <div className="accordion">
                    ...
                    <div className="websites accordion-content">
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.750g.com')
                        }
                      >
                        750g
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.coupdepouce.com')
                        }
                      >
                        Coup de pouce
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.cuisineactuelle.fr')
                        }
                      >
                        Cuisine Actuelle
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.cuisineaz.com')
                        }
                      >
                        CuisineAZ
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('http://cuisinemoiunmouton.com')
                        }
                      >
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('http://www.delice-celeste.com')
                        }
                      >
                        Délice Céleste
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.hervecuisine.com')
                        }
                      >
                        Hervé Cuisine
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.marmiton.org')
                        }
                      >
                        Marmiton
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.recettes.qc.ca')
                        }
                      >
                        Recettes du Québec
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.ricardocuisine.com')
                        }
                      >
                        Ricardo
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://turbigo-gourmandises.fr')
                        }
                      >
                      ...
                      <div
                        className="website-url"
                        onClick={() => shell.openExternal('https://zeste.ca')}
                      >
                        Zeste
                      </div>
                    </div>
                  ...
                  <div className="accordion">
                    ...
                    <div className="websites accordion-content">
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.chefkoch.de')
                        }
                      >
                        Chefkoch
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://eatsmarter.de')
                        }
                      >
                        Eat Smarter
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.essen-und-trinken.de')
                        }
                      >
                        Essen und Trinken
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.kochbar.de')
                        }
                      >
                        Kochbar
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.daskochrezept.de')
                        }
                      >
                        Kochrezept (Das)
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.lecker.de')
                        }
                      >
                        Lecker
                      </div>
                  ...
                  <div className="accordion">
                    ...
                    <div className="websites accordion-content">
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.cookaround.com')
                        }
                      >
                        Cook Around
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.cucchiaio.it')
                        }
                      >
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.lacucinaitaliana.it')
                        }
                      >
                        Cucina Italiana (La)
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://gnambox.com')
                        }
                      >
                        Gnam Box
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.gnamgnam.it')
                        }
                      >
                        GnamGnam
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.gustissimo.it')
                        }
                      >
                        Gustissimo
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.misya.info')
                        }
                      >
                        Misya
                      </div>
                      ...
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.lospicchiodaglio.it')
                        }
                      >
                        Spicchio d'aglio (Lo)
                      </div>
                      <div
                        className="website-url"
                        onClick={() =>
                          shell.openExternal('https://www.vegolosi.it')
                        }
                      >
                        Vegolosi
                      </div>
            ...
            <div
              className={`content${'about' === selectedTab ? ' active' : ''}`}
            >
              <div className="about-section">
                ...
                <div
                  className="sponsor"
                  onClick={() => this.openLinkInBrowser('sponsor')}
                >
                ...
                <div className="about-details">
                  ...
                  <div
                    className="author"
                    onClick={() => this.openLinkInBrowser('author-page')}
                  >
                    {author.name}
                  </div>
                  <div className="link-list">
                    <div
                      className="link"
                      onClick={() => this.openLinkInBrowser('project-page')}
                    >
                      {t('GitHub Repository')}
                    </div>
                    <div
                      className="link"
                      onClick={() => this.openLinkInBrowser('license')}
                    >
                      {t('License')}
                    </div>
                    <div
                      className="link"
                      onClick={() => this.openLinkInBrowser('issues')}
                    >
                      {t('Report an issue')}
                    </div>
                    <div
                    ...
                    <div
                      ...
                      onClick={() => this.openLinkInBrowser('mailto')}
                    >
                      {t('Send me an email')}
                    </div>
                  </div>
                  <div className="release-notes">
                    <div className="notes">
                      <div className="text">{t('Changelog')}</div>
                      <ReactMarkdown source={this.state.releaseNotes} />
                    </div>
                  </div>
                </div>
              </div>
