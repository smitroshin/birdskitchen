        ...
        <div className="modal-content">
          <div className="wrapper">
            <div className="modal-header">
              ...
              {headerIconsTemplate && (
                <span className="header-icons">{headerIconsTemplate()}</span>
              )}
            </div>
            <div className="modal-body">{children}</div>
          </div>
          {footerTemplate && (
            <div className="modal-footer">{footerTemplate()}</div>
          )}
        </div>
...
const Modal = hoistStatics(
  withTranslation()(ModalNotExtended),
  ModalNotExtended
);
